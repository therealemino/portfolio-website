...
export default function About(props) {
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-svg-bg py-32" id="about" ref={props.refProp} data-aos="zoom-in" data-aos-duration="2000">
