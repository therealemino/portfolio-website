...
/* From Next 13 onward <Link> renders the anchor itself, so className and
   onClick go straight on it and a nested <a> would be invalid markup. Under
   Next 12 the opposite was true, and a <MyLink> wrapper class here meant Link
   never injected href: the whole navigation shipped as anchors with no href,
   uncrawlable and unclickable by keyboard. Keep the element a real Link. */
