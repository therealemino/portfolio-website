    ...
    <>
      ...
      <main className="App">
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <h1 className="lg:sr-only text-center font-semibold text-2xl md:text-4xl mb-5">
            About Me
          </h1>
          <div className="grid grid-cols-1 lg:grid-cols-2 place-items-center gap-6">
            ...
            <img
              ...
              alt="Ejei-Okeke Emmanuel"
              className="rounded-md"
            />
            <div>
              <p aria-hidden="true" className="hidden lg:block text-center font-semibold text-2xl md:text-4xl mb-5">
                About Me
              </p>
              <p className="mb-4">
